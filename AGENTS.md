...
5. `npm run test:migrate` + `npm run test:e2e` — E2E (requer `docker compose up -d postgres redis`)
6. `npm run build` — valida compilação
7. Commit + push (ver [`.agent/workflows/abrir-pr.md`](./.agent/workflows/abrir-pr.md) para PRs)
